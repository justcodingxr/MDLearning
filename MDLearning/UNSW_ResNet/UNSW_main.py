...
from Net.ResNet_2 import  ResNet_2
from Net.ResNet_1 import  ResNet_1
from Net.ResNet_3 import  ResNet_3
viz = visdom.Visdom()
...
#UNSW_train.csv,UNSW_val.csv,UNSW_test.csv
db_train = featureDataset('UNSW_afterclean', 'UNSW_afterclean/UNSW-NB15_1234_simple_train_after-onehot-standard.csv',
                          'UNSW-NB15_1234_simple_train_after-onehot-standard.csv','train')
...
db_val = featureDataset('UNSW_afterclean', 'UNSW_afterclean/UNSW-NB15_1234_simple_val_after-onehot-standard.csv',
                        'UNSW-NB15_1234_simple_train_after-onehot-standard.csv','val')
val_loader = DataLoader(db_val,  shuffle=True,batch_size=batchsz,
                          num_workers=2)  # shufftle随机取得[data,labekl]片,但是不会重复;num_workers一次8个进程
db_test = featureDataset('UNSW_afterclean', 'UNSW_afterclean/UNSW-NB15_1234_simple_test_after-onehot-standard.csv',
                         'UNSW-NB15_1234_simple_train_after-onehot-standard.csv','test')
...
def main():
    ...
    for epoch in range(epochs):
        ...
        for x, y in train_loader:
            ...
            optimzer.step()
            if(t%10==0):
                print('now_loss:', loss.item(),'epoch:',epoch)
