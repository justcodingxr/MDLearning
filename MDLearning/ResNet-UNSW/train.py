...
db_train = featureDataset('UNSW-datas', 'UNSW-datas/rawnetdata2.csv', 'readydata2.csv','train')
...
db_val = featureDataset('UNSW-datas', 'UNSW-datas/rawnetdata2.csv', 'readydata2.csv','val')
val_loader = DataLoader(db_val,  shuffle=True,batch_size=batchsz,
                          num_workers=12)  # shufftle随机取得[data,labekl]片,但是不会重复;num_workers一次8个进程
db_test = featureDataset('UNSW-datas', 'UNSW-datas/rawnetdata2.csv', 'readydata2.csv','test')
