...
df = pd.read_csv("../UNSW_beforeclean/UNSW-4part-testdata.csv", names=featurelist, low_memory=False)
...
li = ['d0','d1','d2','d3','d4','d5','d6','d7','d8','d9','d10']
for i in range(11):
...
df.to_csv('../UNSW_afterclean/UNSW_test.csv',index=False,header=False,encoding="utf_8_sig")